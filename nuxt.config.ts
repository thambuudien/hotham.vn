...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    '/dongbhxh': { redirect: '/muc-dong', prerender: false },
    '/mucdong': { redirect: '/muc-dong', prerender: false },
    '/cua-hang': { redirect: 'https://shop.hotham.vn/', prerender: false },
    ...
    '/tu-van-dich-vu-tiet-kiem-buu-dien': { redirect: 'https://blog.hotham.vn/gui-tiet-kiem-tai-buu-dien-lai-suat-tot-nhat-va-nhan-ngan-qua-tang/', prerender: false },
